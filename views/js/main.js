...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    var docu_query = document.getElementsByClassName("randomPizzaContainer");
    var dx = determineDx(docu_query[0], size);
    var width = docu_query[0].offsetWidth;
